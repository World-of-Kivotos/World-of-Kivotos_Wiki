...
export const auditBaseline: AuditDoc = {
  id: 'baseline',
  name: '审计口径与构建证据',
  en: 'Build baseline',
  group: '证据',
  ...
  facts: [
    { label: '源码提交', value: '701093bd8492' },
    { label: 'MOD 版本', value: '1.0.19' },
    { label: '目标产物', value: 'miningdim-1.20.1-1.0.19-all.jar' },
    { label: '审计日期', value: '2026-08-18' },
  ],
  intro:
  ...
  sections: [
    {
      ...
      note: '后两层没有通过时，即使 class 在 JAR 里，也不会写成“已上线玩法”。',
    },
    {
      heading: '源码与产物证据',
      bullets: [
