...
export const auditSystems: AuditDoc = {
  id: 'systems',
  name: '全部装配功能与入口',
  ...
  facts: [
    ...
    { label: 'Subsystem 实现', value: '37' },
    { label: '静态 WebUI 动作', value: '70' },
    { label: 'Forge 配置文件', value: '12' },
    { label: '主包 class', value: '1444' },
  ],
  intro:
  ...
  sections: [
    ...
    },
    {
      ...
      note: 'com.miningdim.command.CommandSystem 的另一套 /mining 虽然物理入包，但没有加入主类，不能按其中的 party/status/list/tp/kick/trap 子命令编写玩家教程。',
    },
    {
      heading: 'WebUI 服务端动作',
      table: {
      ...
      note: '动作总数是静态注册表口径。外部 React 前端是否调用到每一个动作是另一层契约，不能用“后端有 action”替代端到端可玩性。',
    },
    {
      heading: '游戏内 WebUI 的真实边界',
      bullets: [
